...
namespace BlazorHotchocolate.Core.DataGrid;
...
public partial class RfDataGrid<TGridItem> : FluentComponentBase, IHandleEvent, IAsyncDisposable,IDataGrid<TGridItem>
{
    /// <summary>
    ...
    private readonly InternalGridContext<TGridItem> _internalRfGridContext;
    ...
    {
        _columns = [];
        _internalRfGridContext = new(this);
        ...
        columnsFirstCollectedSubscriber.SubscribeOrMove(_internalRfGridContext.ColumnsFirstCollected);
    }
    ...
    void IDataGrid<TGridItem>.AddColumn(ColumnBase<TGridItem> column, SortDirection? initialSortDirection, bool isDefaultSortColumn)
    ...
    private async Task RefreshDataCoreAsync()
    {
        ...
        else
        {
            ...
            _internalRfGridContext.ResetRowIndexes(startIndex);
        }
    ...
    private async Task HandleOnRowFocus(DataGridRowFocusEventArgs args)
    {
        ...
        if (_internalRfGridContext.Rows.TryGetValue(rowId!, out FluentDataGridRow<TGridItem>? row))
        {
